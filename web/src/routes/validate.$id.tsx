  ...
  return (
    <div className="ambient grain min-h-[100dvh] bg-cream">
      <header className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 pt-8 md:px-8">
        ...
        <span className="text-sm text-espresso-soft"><FormattedMessage id="validate.header" values={{ title: session?.title ?? "…" }} /></span>
      </header>
      ...
      <main className="mx-auto grid w-full max-w-6xl gap-6 px-4 pb-24 pt-10 md:grid-cols-[1.2fr_1fr] md:px-8">
        <div className="rise-in rounded-shell bg-paper p-2 ring-1 ring-hairline">
          <div className="flex h-96 flex-col items-center justify-center gap-3 rounded-[calc(2rem-0.375rem)] bg-cream p-8 text-center">
            <p className="font-display text-lg font-semibold"><FormattedMessage id="validate.comingLater" /></p>
        ...
        <div className="rise-in rounded-shell bg-paper p-2 ring-1 ring-hairline" style={{ "--rise-delay": "150ms" } as React.CSSProperties}>
          <div className="rounded-[calc(2rem-0.375rem)] bg-cream p-6">
            <h2 className="text-[10px] uppercase tracking-[0.2em] font-medium text-espresso-soft"><FormattedMessage id="validate.plan" /></h2>
            <dl className="mt-4 space-y-2 text-sm">
              <div className="flex justify-between"><dt className="text-espresso-soft"><FormattedMessage id="validate.type" /></dt><dd>{session?.title}</dd></div>
              <div className="flex justify-between"><dt className="text-espresso-soft"><FormattedMessage id="validate.duration" /></dt><dd>{session?.duration_min} min</dd></div>
              <div className="flex justify-between"><dt className="text-espresso-soft"><FormattedMessage id="validate.mode" /></dt><dd>{session?.mode}</dd></div>
            </dl>
          </div>
        </div>
      </main>
