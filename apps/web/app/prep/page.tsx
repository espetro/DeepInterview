...
// Reads server-only config; must not be statically prerendered.
 ...
 *
 * Server shell: composes the client islands (no auth — OSS runs without sign-in). The report's "Coach me" CTA
